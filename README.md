...
[`coverage_report.txt`](docs/coverage_report.txt) and the [download FIFO verification report (PDF)](https://github.com/JinELEC/FIFO_Verification/raw/main/report/FIFO_Verification_report.pdf).
